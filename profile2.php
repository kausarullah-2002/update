            ...
            <div id="content">
                ...
                <section class="course">
                    ...
                    <h1>Personal Information</h1>
                        ...
                        <form action="formCheck.php" method="POST" ctype="multipart/form-data">
                        ...
                        <div class="course-col">
                            ...
                            <input type="text"  placeholder="Email" name="stdemail" required>
                            <input type="text"  placeholder="Contact" name="contact" required>
                            <input type="text"  placeholder="CNIC Number" name="stdCNIC" required>
                        </div>
                        ...
                        <div id="disabled" class="course-col">
                            ...
                            <input type="text"  placeholder="Father CNIC Number" name="fCNIC" required>
